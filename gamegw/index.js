...
const items = [
  new Item({ position: { x: 289, y: 200 }, imageSrc: './img/warrior/28.png' }),  // Item pertama
  new Item({ position: { x: 354, y: 23 }, imageSrc: './img/warrior/29.png' }),  // Item kedua
  new Item({ position: { x: 19, y: 23 }, imageSrc: './img/warrior/30.png' }),  // Item ketiga
  new Item({ position: { x: 524, y: 265 }, imageSrc: './img/warrior/31.png' })   // Item keempat
]
...
const portal = new Portal({ position: { x: 300, y: 300 }, imageSrc: './img/warrior/portal.png' })
...
function nextLevel() {
  ...
  window.location.href = "../gamegw2/index.html";  // Mengarahkan ke halaman stage baru
}
