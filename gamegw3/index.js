...
const items = [
  new Item({ position: { x: -5, y: 215 }, imageSrc: './img/warrior/38.png' }),  // Item pertama
  new Item({ position: { x: 464, y: 27 }, imageSrc: './img/warrior/39.png' }),  // Item kedua
  new Item({ position: { x: 162, y: 10 }, imageSrc: './img/warrior/40.png' }),  // Item ketiga
  new Item({ position: { x: 382, y: 250 }, imageSrc: './img/warrior/41.png' })   // Item keempat
]
